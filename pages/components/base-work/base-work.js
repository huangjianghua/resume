...
Component({
    ...
    data: {
        ...
        <li>该小程序从设计图到代码设计全由我一人完成，使用组件开发思想实现，目前已有16个较为常见计算功能，后续会不断添加新功能和优化用户体验。</li>
            ...
            },
            {
                ...
                <li>目前已经可以在线使用的功能为根据当前位置获取周边或者根据当前选择的城市来获取和汽车类别相关的所有信息，同时可以获取自己与目的地的距离并实现路线规划导航至目的地。</li>
                </ol>
            </div>`,
            },
            {
                ...
                duty: `<div class="rich-text">
        <ol style="margin:0;padding:0;">
        <li>该程序为《汇车友》小程序的H5版本，主要使用目前最新的Vue3框架进行开发，虽然说两者并非一家但都是使用MVVM的思想，所以从技术上来说Vue和微信小程序都有很多相通的地方，只是宿主不同提供的接口不同。</li>
        <li>该H5版本主要使用目前最流行的Vite工程化构建，以组合式进行开发单页面应用，用组件化开发的思想封装常用的组件，实现了代码的高效复用。</li>
        <li>完全使用Vue3全家桶进行开发，例如路由管理器VueRouter，数据状态管理器Pinia等主要插件，Vue3相对与Vue2变得更加强大组件式函数让开发更为灵活。</li>
    ...
    methods: {
        ...
        navToApp(e) {
            ...
            if (projectLists[listid].shortLink) {
                // 打开符合APPID的小程序
